...
public class TinyDB {
    ...
    public ArrayList<DomenDrink> getListObject(String key){
        Gson gson = new Gson();


        ArrayList<String> objStrings = getListString(key);
        ArrayList<DomenDrink> playerList =  new ArrayList<DomenDrink>();

        for(String jObjString : objStrings){
            DomenDrink player  = gson.fromJson(jObjString,  DomenDrink.class);
    ...
    public void putListObject(String key, ArrayList<DomenDrink> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(DomenDrink player: playerList){
